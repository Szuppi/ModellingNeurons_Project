...
def StableEquilbirumPerturbationScene():
    ...
    save_folder = f'C:/Users/local_user/Desktop/Study/VII_semester/Modelling_Neurons/Project_Animations/stable_equilibrium_perturbation'
...
def UnstableEqulibriumPerturbationScene():
    ...
    save_folder = f'C:/Users/local_user/Desktop/Study/VII_semester/Modelling_Neurons/Project_Animations/unstable_equilibrium_perturbation'
    Path(save_folder).mkdir(parents=True, exist_ok=True)
...
def CurrentRampNullclineShift():
    ...
    save_folder = Path(f'C:/Users/local_user/Desktop/Study/VII_semester/Modelling_Neurons/Project_Animations/current_ramp_nullcline_shift')
    Path(save_folder).mkdir(parents=True, exist_ok=True)
